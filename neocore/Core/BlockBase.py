...
class BlockBase(VerifiableMixin):
    ...
    def Scripts(self):
        ...
        Returns:
            list: with a single `neocore.Core.Witness` object.
        """
        return [self.Script]
    ...
    def GetScriptHashesForVerifying(self):
        ...
        prev_header = Blockchain.GetBlockchain().GetHeader(self.PrevHash.ToBytes())
    ...
    def Verify(self):
        ...
        """
        from neocore.Core.Blockchain import Blockchain
        if not self.Hash.ToBytes() == Blockchain.GetGenesis().Hash.ToBytes():
            return False
