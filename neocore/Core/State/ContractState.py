...
class ContractState(StateBase):
    ...
    def __init__(self, code=None, contract_properties=0, name=None, version=None, author=None, email=None,
        ...
        Args:
            code (neocore.Core.FunctionCode):
            contract_properties (neocore.SmartContract.ContractParameterType): contract type.
            name (bytes):
            version (bytes):
            author (bytes):
            email (bytes):
    ...
    def DetermineIsNEP5(self):
        ...
        Returns:
            bool
        """
        # from neocore.Wallets.NEP5Token import NEP5Token
        #
        # self._is_nep5 = False
