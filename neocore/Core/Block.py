from neocore.Core.BlockBase import BlockBase
...
class Block(BlockBase, InventoryMixin):
    ...
    def __init__(self, prevHash=None, timestamp=None, index=None,
        ...
        Args:
            ...
            script (neocore.Core.Witness): script used to verify the block.
            transactions (list): of neocore.Core.TX.Transaction.Transaction objects.
    ...
    def FullTransactions(self):
        ...
        Returns:
            list: of neocore.Core.TX.Transaction.Transaction objects.
        """
        is_trimmed = False
        try:
    ...
    def Verify(self, completely=False):
        ...
        from neocore.Blockchain import GetBlockchain, GetConsensusAddress
        ...
        if completely:
            ...
            for tx in self.Transactions:
                if not tx.Verify():
                    pass
            raise Exception("Error: Blocks cannot be fully validated at this moment.  please pass completely=False")
