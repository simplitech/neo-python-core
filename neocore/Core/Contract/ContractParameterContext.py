...
from neocore.Core.Contract.Contract import Contract, ContractType
from neocore.Core.Contract.ContractParameterType import ContractParameterType, ToName
...
from neocore.Core.VM import OpCode
